...
Locator: locator('body').locator('[formcontrolname="source"]')
Expected pattern: /http/i
Received string:  "Link to external source"
Timeout: 5000ms

Call log:
  - Expect "toHaveAttribute" with timeout 5000ms
  - waiting for locator('body').locator('[formcontrolname="source"]')
...
> 70 |       await expect(createNewsPage.sourceInput).toHaveAttribute('placeholder', /http/i);
     |                                                ^ Error: expect(locator).toHaveAttribute(expected) failed
  71 |     });
  72 | 
